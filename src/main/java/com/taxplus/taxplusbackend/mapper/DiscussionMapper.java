...
public interface DiscussionMapper extends BaseMapper<Discussion> {
    @Select(value = "insert into discussion (commentator,commentator_type,post_text,post_time) values(#{commentator},#{commentator_type},#{post_text},#{post_time})")
    ...
    @Select(value = "insert into Sub_Discussion (parent_post_id,commentator,commentator_type,post_text,post_time) values(#{parent_post_id},#{commentator},#{commentator_type},#{post_text},#{post_time})")
